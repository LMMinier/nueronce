"""Configuration defaults for the NUERONCE-350M prototype.
...
class RetrievalConfig:
    ...
    k_recall: int = 50
    k_rerank: int = 10
    # Combined-score weights (must mirror nueronce.retrieval.combine_scores).
    w_dense: float = 0.30
    w_sparse: float = 0.20
    w_late: float = 0.25
...
class NueronceConfig:
    """Top-level config aggregating all subsystem defaults (NUERONCE-350M)."""
