"""NUERONCEModel — the end-to-end, trainable realization of the architecture.

A two-level byte language model that exercises the full NUERONCE pipeline:
...
def large_config() -> ModelConfig:
    ...
    bookkeeping-only ``nueronce.config.NueronceConfig``. It is not trained here (that needs
...
__all__ = ["ModelConfig", "NUERONCEModel", "large_config", "chat_config",
