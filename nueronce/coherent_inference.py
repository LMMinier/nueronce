"""Practical coherent-response wrapper for NUERONCE checkpoints.
...
def deterministic_answer(prompt: str) -> Optional[str]:
    ...
    if "what can you do" in text.lower():
        return "I can answer simple questions, use narrow tools for exact arithmetic, and generate short text from the NUERONCE byte model."
    return None
