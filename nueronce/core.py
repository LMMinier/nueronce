...
The actual torch modules live in :mod:`nueronce.blocks` (built from the hand-rolled
primitives in :mod:`nueronce.nn`); this module exposes the design-named classes and
...
class HybridBlock:
    """Design-named wrapper around :class:`nueronce.blocks.HybridBlock`."""
...
class NUERONCECore:
    ...
    Wraps :class:`nueronce.blocks.HybridCoreStack`; ``run`` keeps the design's
...
__all__ = ["HybridBlock", "convergence_detected", "NUERONCECore"]
