...
stage-1 SFT (see ``docs/reports/MICRO_NUERONCE_SFT_100K_REPORT.md``).
...
``nueronce.training.dataset_prep`` for where the manifest is written.
...
hoping. ``nueronce.training.dataset_prep`` still runs a real dedupe/validation
