"""A small, fully-symbolic cognitive loop over the frozen :mod:`nueronce.contract`.

Purpose (the corrected NUERONCE thesis): show that splitting a task across explicit
