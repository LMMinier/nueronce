...
| C++ inference engine (cfna.cpp, zero-dependency) | DONE | `cpp/cfna_engine.cpp` + `scripts/export_cfna_bin.py`; logits parity ≤1e-8 vs float64 oracle incl. real checkpoint, greedy byte-identical (4 tests); **657 B/s, 14.3x** vs Python dense incl. startup (`cpp/README.md`) |
