"""MicroCFNAModel — the real CFNA architecture (not a smaller stand-in) ported
onto the from-scratch microtorch engine. No PyTorch import anywhere in this
...
from cfna.microtorch.models import MicroSFTBackend
from cfna.microtorch.optim import AdamW, clip_grad_norm_
from cfna.microtorch.tensor import no_grad
from cfna.training.dialogue_data import held_out_split, SFT_DATASET
from cfna.training.vgrft import VGRFTTrainer


def _tiny() -> MicroModelConfig:
