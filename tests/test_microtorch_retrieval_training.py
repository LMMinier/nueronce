"""Retrieval is wired into training and MicroCFNAModel learns to use it —
mirrors tests/test_retrieval_training.py. No PyTorch needed."""

import numpy as np

from cfna.microtorch import retrieval_train as rt
from cfna.microtorch.cfna_model import MicroCFNAModel, MicroModelConfig


def _cfg():
    return MicroModelConfig(byte_embed_dim=16, d_local=24, d_model=32, p_max=12,
