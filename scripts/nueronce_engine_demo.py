...
Usage:  python scripts/nueronce_engine_demo.py
"""
...
from nueronce.engine import Tensor, functional as F
from nueronce.engine.models import MicroByteLM, train_overfit
...
if __name__ == "__main__":
    print("=== engine: a from-scratch autograd engine for NUERONCE ===")
    gradient_check()
    torch_parity()
    train()
    print("The engine implements tensors, reverse-mode autograd, the NUERONCE operators\n"
