...
CHECKPOINT = Path(r"runs\foundational_mem32\latest_best.pt")
DATASET = Path(r"data\foundational_mem32\train.jsonl")
SYSTEM_FILE = Path(r"runs\forgeloop\system_prompt.txt")
OUTPUT = Path(r"metrics\foundational_mem32_generation.json")
