#!/usr/bin/env python3
"""Run the 355M-class CFNA through the MicroTorch StreamFactor path.
...
def main() -> None:
    ...
    ap.add_argument("--save-dir", default="checkpoints/micro_cfna_355m")
    ap.add_argument("--metrics-dir", default="metrics/micro_cfna_355m")
    ...
    from cfna.microtorch.optim import StreamFactor
    from cfna.microtorch.scaling import base_355m_config, enable_training_dtype
    import cfna.training.sharded_sft as trainer
    ...
    print("MicroTorch base_355m + StreamFactor + float32")
