#!/usr/bin/env python3
"""Run NUERONCE Nueronce Engine 35M training with CPU-safe BLAS defaults.

Nueronce Engine performs many small matrix multiplications. On machines exposing large
...
PROGRAMS = {
    "pretrain": ROOT / "scripts/train_engine_35m_split_pretrain.py",
    "sft": ROOT / "scripts/train_engine_35m_split_step.py",
}
