#!/usr/bin/env python3
"""Crash-safe, response-only phased SFT for the 35M Nueronce Engine NUERONCE model.
...
from nueronce.engine.optim import clip_grad_norm_
...
def render_record(record):
    ...
    context = (
        f"System: {record.get('system_message', 'You are NUERONCE.')}\n"
        f"Evidence:\n{evidence}\n"
...
def main():
    ...
    payload = {
        "format": "engine-base35m-phased-sft-v2",
        "config": cfg.__dict__,
