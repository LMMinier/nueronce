"""Core runtime data structures for the CFNA hybrid foundational model.
...
# The typed recurrent-memory channels (see cfna.memory).
...
class CognitiveEmbeddingBundle:
    ...
    The central thesis of CFNA: a single cosine space cannot safely encode
