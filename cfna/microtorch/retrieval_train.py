"""Retrieval-augmented training on microtorch — the port of
``cfna.retrieval_train`` (needs PyTorch) for :class:`MicroCFNAModel`.
...
The retriever (``cfna.impl.embed_text`` + ``cfna.ops.cosine``) is frozen and
