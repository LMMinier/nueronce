"""End-to-end CFNA inference with evidence-conditioned generation.
...
prompt and retrieval tensors through ``CFNAModel.generate``.
"""
...
SYSTEM_MESSAGE = (
    "You are CFNA. Answer only from trusted evidence and the response plan. "
...
def evidence_to_retrieval_tensors(
    ...
    *,
    ...
    """Convert approved evidence records into CFNAModel retrieval tensors."""
...
@dataclass
class ModelRenderer:
    """Evidence-conditioned renderer backed by ``CFNAModel.generate``."""
