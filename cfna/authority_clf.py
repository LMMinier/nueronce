...
microtorch backend via :mod:`cfna.authority_features`. The model is a tiny MLP
...
:mod:`cfna.microtorch.authority_clf`, so every provenance/authority benchmark
runs on NumPy alone.
...
if _HAVE_TORCH:
    ...
    from .microtorch.authority_clf import AuthorityClassifier  # noqa: F401
