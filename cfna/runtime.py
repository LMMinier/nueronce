"""Compact, low-VRAM runtime and the top-level CFNA_Respond orchestration.
...
- :func:`cfna_respond` documents the end-to-end control flow (perceive → patch →
...
# The full streaming runtime (CompactRuntime) and cfna_respond orchestration are
# documented in docs/architecture.md and the design doc's CFNA_Respond pseudocode.
